# courseproject-purejs-simplegallery
...
### 2. Buatlah file style.css kemudian tulis dengan kode berikut 
```
/*
=============== 
Fonts
...
### 3. Buatlah file app-class.js kemudian tulis dengan kode berikut,
```
